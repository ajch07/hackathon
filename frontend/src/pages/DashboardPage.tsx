        ...
        try {
          ...
          setDashboardData({
            ...
            summary: {
              ...
              overallScore: Math.round(summary.overall_score),
              focusScore: Math.round(summary.focus_score),
              memoryScore: Math.round(summary.memory_score),
              reactionScore: Math.round(summary.reaction_score),
